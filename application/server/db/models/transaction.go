...
type Transaction struct {
	...
	RealtyCertHash      string    `gorm:"size:255;index;not null" json:"realtyCertHash"`      // 房产ID
	SellerCitizenIDHash string    `gorm:"size:255;index;not null" json:"sellerCitizenIDHash"` // 卖方身份证号
	SellerOrganization  string    `gorm:"size:64;index;not null" json:"sellerOrganization"`   // 卖方身份组织
	BuyerCitizenIDHash  string    `gorm:"size:255;index;not null" json:"buyerCitizenIDHash"`  // 买方身份证号
